var Zuck = function(t) {
    ...
    function n(a) { if (e[a]) return e[a].exports; var i = e[a] = { i: a, l: !1, exports: {} }; return t[a].call(i.exports, i, i.exports, n), i.l = !0, i.exports }
    ...
    t.exports = function(n) {
        var a = function(t) { return document.querySelectorAll(t)[0] },
            i = function(t, e) { return t && t[e] || "" },
            o = function(t, e) {
                if (t)
            ...
            c = function(t, e, n) {
                ...
                o(a, (function(e, a) { t[a] = n }))
            },
            r = function(t, e, n) {
                var a = [n.toLowerCase(), "webkit".concat(n), "MS".concat(n), "o".concat(n)];
                o(a, (function(n, a) { t.addEventListener(a, e, !1) }))
            },
            s = function(t, e) { r(t, e, "AnimationEnd") },
            l = function(t, e) { t.firstChild ? t.insertBefore(e, t.firstChild) : t.appendChild(e) },
            d = function(t, e) {
                var d = this,
                    u = function(t, n) { var a = function(t) { return void 0 !== t }; return n ? a(e[t]) && a(e[t][n]) ? e[t][n] : g[t][n] : a(e[t]) ? e[t] : g[t] },
                    m = function(t, e) { var n = "RequestFullScreen"; try { e ? (document.fullscreenElement || document.webkitFullscreenElement || document.mozFullScreenElement || document.msFullscreenElement) && (document.exitFullscreen ? document.exitFullscreen().catch((function() {})) : (document.mozCancelFullScreen || document.mozCancelFullScreen) && document.mozCancelFullScreen().catch((function() {}))) : t.requestFullScreen ? t.requestFullScreen() : t["ms".concat(n)] ? t["ms".concat(n)]() : t["moz".concat(n)] ? t["moz".concat(n)]() : t["webkit".concat(n)] && t["webkit".concat(n)]() } catch (t) { console.warn("[Zuck.js] Can't access fullscreen") } },
                    v = function(t, e, n, i) {
                        var o = e > 0 ? 1 : -1,
                            r = Math.abs(e) / a("#zuck-modal").offsetWidth * 90 * o;
                        if (u("cubeEffect")) { var s = 0 === r ? "scale(0.95)" : "scale(0.930,0.930)"; if (c(a("#zuck-modal-content").style, "Transform", s), r < -90 || r > 90) return !1 }
                    ...
                    f = function(t, e, n, a) {
                        ...
                        if (t) {
                            if (t.offsetParent)
                                do { if (i += t.offsetLeft, o += t.offsetTop, t === a) break } while (t = t.offsetParent);
                            e && (o -= e), n && (i -= n)
                        }
                        return [i, o]
                    };
                ...
                var p = function(t) {
                        ...
                        var s = !1;
                        if (o(c, (function(t, e) { a < e[0] && !s && ("string" == typeof e[2] ? s = e[r] : null !== e && (s = Math.floor(a / e[2]) + e[1])) })), s) return s;
                        var l = e.getDate(),
                            d = e.getMonth(),
                            m = e.getFullYear();
                    ...
                    g = {
                        ...
                        list: !1,
                        localStorage: !0,
                        callbacks: { onOpen: function(t, e) { e() }, onView: function(t) {}, onEnd: function(t, e) { e() }, onClose: function(t, e) { e() }, onNextItem: function(t, e, n) { n() }, onNavigateItem: function(t, e, n) { n() } },
                        template: {
                            timelineItem: function(t) { return '\n            <div class="story '.concat(!0 === i(t, "seen") ? "seen" : "", '">\n              <a class="item-link" href="').concat(i(t, "link"), '">\n                <span class="item-preview">\n                  <img lazy="eager" src="').concat(u("avatars") || !i(t, "currentPreview") ? i(t, "photo") : i(t, "currentPreview"), '" />\n                </span>\n                <span class="info" itemProp="author" itemScope itemType="http://schema.org/Person">\n                  <strong class="name" itemProp="name">').concat(i(t, "name"), '</strong>\n                  <span class="time">').concat(i(t, "lastUpdatedAgo"), '</span>\n                </span>\n              </a>\n              \n              <ul class="items"></ul>\n            </div>') },
                            ...
                            viewerItem: function(t, e) { return '<div class="story-viewer">\n                    <div class="head">\n                      <div class="left">\n                        '.concat(u("backButton") ? '<span class="back">&lsaquo;</span>' : "", '\n\n                        <span class="item-preview">\n                          <img lazy="eager" class="profilePhoto" src="').concat(i(t, "photo"), '" />\n                        </span>\n\n                        <div class="info">\n                          <strong class="name">').concat(i(t, "name"), '</strong>\n                          <span class="time">').concat(i(t, "timeAgo"), '</span>\n                        </div>\n                      </div>\n\n                      <div class="right">\n                        <span class="time">').concat(i(e, "timeAgo"), '</span>\n                        <span class="loading"></span>\n                        <span class="close" tabIndex="2">&times;</span>\n                      </div>\n                    </div>\n\n                    <div class="slides-pointers">\n                      <div class="wrap"></div>\n                    </div>\n\n                    ').concat(u("paginationArrows") ? '<div class="slides-pagination">\n                          <span class="previous">&lsaquo;</span>\n                          <span class="next">&rsaquo;</span>\n                        </div>' : "", "\n                  </div>") },
                            viewerItemPointer: function(t, e, n) { return '<span \n                    class="'.concat(e === t ? "active" : "", " ").concat(!0 === i(n, "seen") ? "seen" : "", '"\n                    data-index="').concat(t, '" data-item-id="').concat(i(n, "id"), '">\n                      <b style="animation-duration:').concat("" === i(n, "length") ? "3" : i(n, "length"), 's"></b>\n                  </span>') },
                            viewerItemBody: function(t, e, n) { return '<div \n                    class="item '.concat(!0 === i(n, "seen") ? "seen" : "", " ").concat(e === t ? "active" : "", '"\n                    data-time="').concat(i(n, "time"), '" data-type="').concat(i(n, "type"), '" data-index="').concat(t, '" data-item-id="').concat(i(n, "id"), '">\n                    ').concat("video" === i(n, "type") ? '<video class="media" muted webkit-playsinline playsinline preload="auto" src="'.concat(i(n, "src"), '" ').concat(i(n, "type"), '></video>\n                        <b class="tip muted">').concat(u("language", "unmute"), "</b>") : '<img loading="auto" class="media" src="'.concat(i(n, "src"), '" ').concat(i(n, "type"), " />\n                    "), "\n\n                    ").concat(i(n, "link") ? '<a class="tip link" href="'.concat(i(n, "link"), '" rel="noopener" target="_blank">\n                            ').concat(i(n, "linkText") && "" !== i(n, "linkText") ? i(n, "linkText") : u("language", "visitLink"), "\n                          </a>") : "", "\n                  </div>") }
                        },
                        language: { unmute: "Включить звук", keyboardTip: "Нажмите пробел для перехода", visitLink: "Перейти по ссылке", time: { ago: "Назад", hour: "Час назад", hours: "Часов назад", minute: "Минут назад", minutes: "Минуты назад", fromnow: "from now", seconds: "Секунды назад", yesterday: "Вчера", tomorrow: "Завтра", days: "Дней назад" } }
                    },
                    h = function() {
                        ...
                        }, u("openEffect") && c.classList.add("with-effects"), u("rtl") && c.classList.add("rtl"), e = function() { c.classList.contains("closed") && (g.innerHTML = "", c.style.display = "none", c.classList.remove("closed"), c.classList.remove("animated")) }, (t = c).transitionEndEvent || (t.transitionEndEvent = !0, r(t, e, "TransitionEnd")), document.body.appendChild(c));
                        var g = a("#zuck-modal-content"),
                                ...
                                u("cubeEffect") ? "previous" === n ? o = e.slideWidth : "next" === n && (o = -1 * e.slideWidth) : o = -1 * f(r[n])[0], v(c, o, 600, null), setTimeout((function() {
                                    ...
                                    if ("" !== n && r[n] && "" !== i) {
                                        ...
                                        if (f) {
                                            ...
                                            d.data[m].currentItem = parseInt(f[0].getAttribute("data-index"), 10), f[0].innerHTML = '<b style="'.concat(p.style.cssText, '"></b>'), s(f[0].firstElementChild, (function() { d.nextItem(!1) }))
                                        }
                                        if (v(c, "0", 0, null), f) {
                            ...
                            I = function(t, e, n) {
                                ...
                                g.className = "slides", o(r, (function(e, n) { n.timeAgo = p(i(n, "time")), b > e && (t.items[e].timeAgo = n.timeAgo, t.items[e].seen = !0, n.seen = !0), v += u("template", "viewerItemPointer")(e, b, n), m += u("template", "viewerItemBody")(e, b, n) })), g.innerHTML = m;
                                var k = g.querySelector("video"),
                                    w = function(t) { t.muted ? S.classList.add("muted") : S.classList.remove("muted") };
                                k && (k.onwaiting = function(t) { k.paused && (S.classList.add("paused"), S.classList.add("loading")) }, k.onplay = function() { w(k), S.classList.remove("stopped"), S.classList.remove("paused"), S.classList.remove("loading") }, k.onload = k.onplaying = k.oncanplay = function() { w(k), S.classList.remove("loading") }, k.onvolumechange = function() { w(k) });
                                var L = document.createElement("div");
                                L.innerHTML = u("template", "viewerItem")(t, b);
                                var S = L.firstElementChild;
                                S.className = "story-viewer muted ".concat(e, " ").concat(n ? "" : "stopped", " ").concat(u("backButton") ? "with-back-button" : ""), S.setAttribute("data-story-id", f), S.querySelector(".slides-pointers .wrap").innerHTML = v, o(S.querySelectorAll(".close, .back"), (function(t, e) { e.onclick = function(t) { t.preventDefault(), h.close() } })), S.appendChild(g), "viewing" === e && x(S, S.querySelectorAll('[data-index="'.concat(b, '"].active')), !1), o(S.querySelectorAll(".slides-pointers [data-index] > b"), (function(t, e) { s(e, (function() { d.nextItem(!1) })) })), "previous" === e ? l(c, S) : c.appendChild(S)
                            };
                        return {
                            show: function(t, e) {
                                var i = a("#zuck-modal");
                                u("callbacks", "onOpen")(t, (function() {
                                        ...
                                        var e = a("#zuck-modal"),
                                            ...
                                            p = function(t) {
                                                ...
                                                if ("A" !== t.target.nodeName) {
                                                    ...
                                                    var v = d.clientX,
                                                        p = d.clientY;
                                                    c = { x: v, y: p, time: Date.now(), valid: !0 }, p < 80 || p > e.slideHeight - 80 ? c.valid = !1 : (t.preventDefault(), r = void 0, s = {}, i.addEventListener("mousemove", y), i.addEventListener("mouseup", g), i.addEventListener("mouseleave", g), i.addEventListener("touchmove", y), i.addEventListener("touchend", g), n && n.classList.add("paused"), L(), l = setTimeout((function() { n.classList.add("longPress") }), 600), m = setTimeout((function() { clearInterval(m), m = !1 }), 250))
                                                }
                                            },
                                            y = function(t) {
                                            ...
                                            g = function t(f) {
                                                ...
                                                if (c && !c.valid);
                                                    ...
                                                    if (l && clearInterval(l), p && (x(p, p.querySelectorAll(".active"), !1), p.classList.remove("longPress"), p.classList.remove("paused")), m) {
                                                        clearInterval(m), m = !1;
                                                        var A = function() { w || (g.x > n.screen.availWidth / 3 || !u("previousTap") ? u("rtl") ? d.navigateItem("previous", f) : d.navigateItem("next", f) : u("rtl") ? d.navigateItem("next", f) : d.navigateItem("previous", f)) },
                                    ...
                                    var s = function() { i.classList.contains("fullscreen") && u("autoFullScreen") && n.screen.availWidth <= 1024 && m(i), i.focus() };
                                    if (u("openEffect")) {
                                        var l = a("#".concat(y, ' [data-id="').concat(t, '"] .item-preview')),
                                            p = f(l);
                                        i.style.marginLeft = "".concat(p[0] + l.offsetWidth / 2, "px"), i.style.marginTop = "".concat(p[1] + l.offsetHeight / 2, "px"), i.style.display = "block", i.slideWidth = a("#zuck-modal .story-viewer").offsetWidth, setTimeout((function() { i.classList.add("animated") }), 10), setTimeout((function() { s() }), 300)
                            ...
                            close: function() {
                                var t = a("#zuck-modal");
                                u("callbacks", "onClose")(d.internalData.currentStory, (function() { u("backNative") && (n.location.hash = ""), m(t, !0), u("openEffect") ? t.classList.add("closed") : (g.innerHTML = "", t.style.display = "none") }))
                            }
                        }
                    }(),
                    b = function(t, e) {
                        ...
                        try { d.data[n] || (d.data[n] = {}), d.data[n].id = n, d.data[n].photo = t.getAttribute("data-photo"), d.data[n].name = t.querySelector(".name").innerText, d.data[n].link = t.querySelector(".item-link").getAttribute("href"), d.data[n].lastUpdated = t.getAttribute("data-last-updated"), d.data[n].seen = a, d.data[n].items || (d.data[n].items = [], d.data[n].noItems = !0) } catch (t) { d.data[n] = { items: [] } }
                        t.onclick = function(t) { t.preventDefault(), h.show(n) };
                    ...
                    k = function(t) {
                        ...
                        if (e) { var i = a("#".concat(y, ' [data-id="').concat(e, '"]'))[n]; if (i) { var o = i.getAttribute("data-id"); return d.data[o] || !1 } }
                        return !1
                    },
                    w = function() {
                    ...
                    x = function(t, e, n) {
                        ...
                        if (o && o.pause(), "video" === a.getAttribute("data-type")) {
                            ...
                            var s = function() { r.duration && c(i.getElementsByTagName("b")[0].style, "AnimationDuration", "".concat(r.duration, "s")) };
                    ...
                    L = function() { var t = d.internalData.currentVideoElement; if (t) try { t.pause() } catch (t) {} },
                    ...
                    I = function(t) { if (u("localStorage")) { var e = "zuck-".concat(y, "-").concat(t); return !!n.localStorage[e] && JSON.parse(n.localStorage[e]) } return !1 };
                d.data = u("stories") || {}, d.internalData = {}, d.internalData.seenItems = I("seenItems") || {}, d.add = d.update = function(e, n) {
                    ...
                    }!1 === e.seen && (d.internalData.seenItems[r] = !1, E("seenItems", d.internalData.seenItems)), c.setAttribute("data-id", r), c.setAttribute("data-photo", i(e, "photo")), c.setAttribute("data-last-updated", i(e, "lastUpdated")), b(c), s || u("reactive") || (n ? t.appendChild(c) : l(t, c)), o(m, (function(t, e) { d.addItem(r, e, n) })), n || w()
                }, d.next = function() { h.next() }, d.remove = function(t) {
                    ...
                    if (!u("reactive")) {
                        ...
                        if (!u("reactive") || e) {
                            o(a, (function(t, e) {
                                for (var n = e.firstElementChild, a = n.firstElementChild, o = { id: n.getAttribute("data-id"), src: n.getAttribute("href"), length: n.getAttribute("data-length"), type: n.getAttribute("data-type"), time: n.getAttribute("data-time"), link: n.getAttribute("data-link"), linkText: n.getAttribute("data-linkText"), preview: a.getAttribute("src") }, c = n.attributes, r = ["data-id", "href", "data-length", "data-type", "data-time", "data-link", "data-linktext"], s = 0; s < c.length; s++) - 1 === r.indexOf(c[s].nodeName) && (o[c[s].nodeName.replace("data-", "")] = c[s].nodeValue);
                                i.push(o)
                            })), d.data[n].items = i;
                    ...
                    if (c && y && g) {
                        ...
                        (b = u("callbacks", b ? "onNavigateItem" : "onNextItem"))(n, g.getAttribute("data-story-id"), (function() { "previous" === t ? (l.classList.remove("seen"), m.classList.remove("seen")) : (l.classList.add("seen"), m.classList.add("seen")), l.classList.remove("active"), m.classList.remove("active"), y.classList.remove("seen"), y.classList.add("active"), g.classList.remove("seen"), g.classList.add("active"), o(c.querySelectorAll(".time"), (function(t, e) { e.innerText = p(g.getAttribute("data-time")) })), d.data[n].currentItem = d.data[n].currentItem + r, x(c, f, e) }))
                    } else c && "previous" !== t && h.next(e)
                };
                return function() {
                    if (t && t.querySelector(".story") && o(t.querySelectorAll(".story"), (function(t, e) { b(e) })), u("backNative") && (n.location.hash === "#!".concat(y) && (n.location.hash = ""), n.addEventListener("popstate", (function(t) { n.location.hash !== "#!".concat(y) && (n.location.hash = "") }), !1)), !u("reactive")) {
                        var e = I("seenItems");
                        o(Object.keys(e), (function(t, n) { d.data[n] && (d.data[n].seen = e[n]) }))
                    }
                    o(u("stories"), (function(t, e) { d.add(e, !0) })), w();
        ...
        return d.buildTimelineItem = function(t, e, n, a, i, c) { var r = { id: t, photo: e, name: n, link: a, lastUpdated: i, items: [] }; return o(c, (function(t, e) { r.items.push(d.buildStoryItem.apply(d, e)) })), r }, d.buildItem = d.buildStoryItem = function(t, e, n, a, i, o, c, r, s) { return { id: t, type: e, length: n, src: a, preview: i, link: o, linkText: c, seen: r, time: s } }, t.exports && (e = t.exports = d), e.ZuckJS = d, d
    }(window || {})
}]);